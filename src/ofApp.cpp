...
void ofApp::setup(){
    ...
    backImg.load("back1_1.png");
    backImg2.load("back1_2.png");
    backImg3.load("back1_3.png");
    ...
    mode = 2;
    lineColor = ofColor::fromHex(0x4a4561); //線の色
...
void ofApp::roundLine(glm::vec2 p0, glm::vec2 p1, float lineWidth){
    drawCap_round_first(p0, p1, lineWidth);
    drawLine(p0, p1, lineWidth);
    drawCap_round_last(p0, p1, lineWidth);
}

//--------------------------------------------------------------
void ofApp::drawLine(glm::vec2 p0, glm::vec2 p1, float lineWidth){
    glm::vec2 base;
    glm::vec2 T[4];
...
//--------------------------------------------------------------
void ofApp::drawCap_round_first(glm::vec2 p0, glm::vec2 p1, float lineWidth){
    //最初のキャップ
...
//--------------------------------------------------------------
void ofApp::drawCap_round_last(glm::vec2 p0, glm::vec2 p1, float lineWidth){
    //最後のキャップ
    vector<glm::vec2> A;
    float half_lineWidth = lineWidth/2;
